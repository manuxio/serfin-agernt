...
const setconversationNameInOpenChat = () => {};
const activeUser = () => {};
...
class Chats extends Component {
    ...
    openUserChat(e, chat) {
      e.preventDefault();
      this.props.appActions.setActiveChat(chat._id);
                                                ...
                                                <li key={key} id={"conversation" + key} className={chat.unRead ? "unread" : chat.isTyping ?  "typing" :  key === this.props.active_user ? "active" : ""}>
                                                    <Link to="#" onClick={(e) => this.openUserChat(e, chat)}>
                                                        <Media>
                                                                    ...
                                                                    <div className={"chat-user-img " + chat.status +" align-self-center mr-3"}>
                                                                        <div className="avatar-xs">
                                                                            <span className="avatar-title rounded-circle bg-soft-primary text-primary">
                                                                                {chat.name.charAt(0).toUpperCase()}{chat.name.charAt(1)}
                                                                            </span>
                                                                        </div>
                                                                        {
                                                            ...
                                                            <div className="font-size-11">{moment(chat.date).format('HH:mm')}</div>
                                                            {chat.unRead === 0 ? null :
